...
# Account Information
to = 'somnathbghule@gmail.com' # Email to send to.
gmail_user = 'somnath.bhaskar.ghule@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'Admin@123' # Gmail password.
